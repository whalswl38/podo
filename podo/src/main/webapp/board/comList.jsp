...
<%
	...
	if(totalCount > 0){
		...
		list = boardDao.comJobList(board);
	}
...
$(document).ready(function(){
    ...
    $("#btnSearch").on("click", function(){
    	...
    	document.comListForm.action = "/board/comList.jsp";
    	document.comListForm.submit();
    });
    
    $("#btnWrite").on("click", function(){
    	document.comListForm.jobSeq.value = "";
    	document.comListForm.action = "/board/write.jsp";
    	document.comListForm.submit();
    });
...
function fn_view(jobSeq){
	...
	document.comListForm.action = "/board/comDetail.jsp";
	document.comListForm.submit();
}
...
<div class="container">
	<div style="width:500px; float: left;" class="input-group mb-3">
		...
		<input type="text" name="_searchValue" id="_searchValue" value="<%=searchValue%>" class="form-control mx-1" maxlength="20" style="width:auto;ime-mode:active;"/>
	...
	<div style="float:right;">
		<button id="btnWrite" style="float: right" class="btn btn-purple"><i class="bi bi-pencil"></i>공고등록</button>
	</div>
	<table class="table">
		<thead>
